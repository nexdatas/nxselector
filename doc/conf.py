# -*- coding: utf-8 -*-
#
# nxsselector documentation build configuration file, created by
...
htmlhelp_basename = 'nxsselectordoc'
...
latex_documents = [
  ('index', 'nxsselector.tex', u'nxsselector Documentation',
   u'Author', 'manual'),
]
...
texinfo_documents = [
  ('index', 'nxsselector', u'nxsselector Documentation',
   u'Author', 'nxsselector', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'nxsselector'
epub_author = u'Author'
epub_publisher = u'Author'
epub_copyright = u'2016, Author'

# The basename for the epub file. It defaults to the project name.
# epub_basename = u'nxsselector'
